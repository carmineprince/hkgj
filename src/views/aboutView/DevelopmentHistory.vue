  ...
  <div style="text-align: center;">
    <div v-if="isDetail == 0">
      ...
      <Page v-if="this.$store.getters.getShowMethod == 1" id="comp-activity-page-control" :total="total" prev-text="上一页"
            ...
            :page-size="10"
      />
      <Page v-else id="comp-activity-page-control" :total="total" prev-text="prev" next-text="next" :styles="pageStyles"
            class-name="test"
            @on-change="pageNumberChange"
            :page-size="10"
      />
    ...
    <div v-else style="text-align: left;padding: 30px;min-height: 500px">
      <Breadcrumb id="breadcrumb-item" separator=">">
        <BreadcrumbItem><a @click="backToGroupAction">发展历程</a></BreadcrumbItem>
