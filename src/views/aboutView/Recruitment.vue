<template>
  <div style="text-align: center;">
    <h2 v-if="this.$store.getters.getShowMethod == 1" style="line-height: 60px;">人才招聘</h2>
    <h2 v-else style="margin-bottom: 30px">Talent Recruitment</h2>
    <div v-if="isDetail == 0">
    ...
    <div v-else style="text-align: left;padding: 30px;min-height: 500px">
      <Breadcrumb v-if="this.$store.getters.getShowMethod == 1" class="breadcrumb-item" separator=">">
        <BreadcrumbItem><a @click="backToGroupAction">人才招聘</a></BreadcrumbItem>
        <BreadcrumbItem>详情</BreadcrumbItem>
      </Breadcrumb>
      <Breadcrumb v-else class="breadcrumb-item" separator=">">
        <BreadcrumbItem><a @click="backToGroupAction">Talent Recruitment</a></BreadcrumbItem>
