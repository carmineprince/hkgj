<template>
  <div style="text-align: center;">
    <h2 v-if="this.$store.getters.getShowMethod == 1" style="line-height:60px">新闻热点</h2>
    <h2 v-else style="margin-bottom: 30px">News hotspots</h2>
    <div v-if="isDetail == 0">
    ...
    <div class="article-container" v-else style="text-align: left;min-height: 500px">
      <Breadcrumb v-if="this.$store.getters.getShowMethod == 1" class="breadcrumb-item" separator=">">
        <BreadcrumbItem><a @click="backToGroupAction">新闻热点</a></BreadcrumbItem>
        <BreadcrumbItem>详情</BreadcrumbItem>
      </Breadcrumb>
      <Breadcrumb v-else class="breadcrumb-item" separator=">">
        <BreadcrumbItem><a @click="backToGroupAction">News hotspots</a></BreadcrumbItem>
